...
export default function Header() {
    ...
    // Dynamic cart count from Redux store
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4 z-20">
                        ...
                        <div className="relative flex items-center">
                            <input
                                type="text"
                                placeholder="Search..."
                                className={`transition-all duration-300 ease-in-out border-b px-3 py-1 text-sm sm:text-base outline-0 w-full ${searchOpen ? "w-64 opacity-100" : "w-0 opacity-0 p-0 border-b"
                                    }`}
                            />
                            <button
                        ...
                        <Link href="/Cart" className="relative group">
                            ...
                            <span className="absolute top-0 -right-1 bg-black text-white text-xs w-5 h-5 flex items-center justify-center rounded-full">{cartItemCount}</span>
                        </Link>
