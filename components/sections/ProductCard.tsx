            ...
            <div className="group bg-white overflow-visible shadow-md transition-shadow duration-300">
                <div className="relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-4">
                        <Link href="#" className="bg-white text-gray-900 px-6 py-3 flex items-center space-x-2 hover:bg-gray-100 transition-colors text-lg font-semibold shadow-2xl transform group-hover:scale-105 duration-300">
                            <IoCartOutline />
        ...
        <div className="group pb-4 sm:pb-6 lg:pb-10">
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <Link href="#" className="bg-white text-black px-5 py-2.5 sm:px-6 sm:py-3 flex items-center space-x-2 hover:bg-gray-100 transition-colors text-sm sm:text-base font-semibold shadow-lg">
                        <IoCartOutline />
                        <span>ADD TO CART</span>
                    </Link>
                </div>
